...
#include "Patron_Observer/NaveEnemigaCaza.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PATRON_OBSERVER_API UClass* Z_Construct_UClass_ANaveEnemigaCaza_NoRegister();
	PATRON_OBSERVER_API UClass* Z_Construct_UClass_ANaveEnemigaCaza();
	PATRON_OBSERVER_API UClass* Z_Construct_UClass_ANaveEnemiga();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANaveEnemigaCaza_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANaveEnemigaCaza_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UObservador_NoRegister, (int32)VTABLE_OFFSET(ANaveEnemigaCaza, IObservador), false },
		};
	...
	IMPLEMENT_CLASS(ANaveEnemigaCaza, 2448967212);
	template<> PATRON_OBSERVER_API UClass* StaticClass<ANaveEnemigaCaza>()
	{
		return ANaveEnemigaCaza::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ANaveEnemigaCaza(Z_Construct_UClass_ANaveEnemigaCaza, &ANaveEnemigaCaza::StaticClass, TEXT("/Script/Patron_Observer"), TEXT("ANaveEnemigaCaza"), false, nullptr, nullptr, nullptr);
